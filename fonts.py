...
def load_variant(size: int, font_key: str = DEFAULT_FONT_KEY, bold: bool = False, italic: bool = False) -> ImageFont.ImageFont:
    return FONT_CATALOG.load_variant(size, font_key, bold=bold, italic=italic)
